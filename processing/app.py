...
def populate_stats():
    ...
    distance_covered_url = f"{url}/readings/distance?distance_timestamp={old_datetime}&end_timestamp={current_timestamp}" # Lab 11
    distance_covered_response = requests.get(distance_covered_url)

    running_pace_url = f"{url}/readings/pace?pace_timestamp={old_datetime}&end_timestamp={current_timestamp}" # Lab 11
