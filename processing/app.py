...
def populate_stats():
    ...
    distance_covered_url = f"{url}/readings/distance?timestamp={current_timestamp}&end_timestamp={old_datetime}" # Lab 11

    distance_covered_response = requests.get(distance_covered_url)

    running_pace_url = f"{url}/readings/pace?timestamp={current_timestamp}&end_timestamp={old_datetime}" # Lab 11
