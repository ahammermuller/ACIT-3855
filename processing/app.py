...
def populate_stats():
    ...
    distance_covered_url = f"{url}/readings/distance?start={old_datetime}&end={current_timestamp}" # Lab 11
    distance_covered_response = requests.get(distance_covered_url)

    running_pace_url = f"{url}/readings/pace?start={old_datetime}&end={current_timestamp}" # Lab 11
